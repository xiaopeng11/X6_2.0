...
+ (CGRect)defaultFrame {
    return CGRectMake(0, 0, KScreenWidth, kBDKNotifyHUDDefaultHeight);
}
...
- (void)setCurrentOpacity:(CGFloat)currentOpacity {
    ...
    self.backgroundView.backgroundColor = [Mycolor colorWithAlphaComponent:currentOpacity];
