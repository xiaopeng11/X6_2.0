...
#warning 把self注册为SDK的delegate
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithName:@"新建" target:self action:@selector(createGroup)];
}
...
- (UISearchBar *)searchBar
{
    if (_searchBar == nil) {
        ...
        _searchBar.backgroundColor = [UIColor colorWithRed:0.747 green:0.756 blue:0.751 alpha:.7];
...
//            NSString *imageName = group.isPublic ? @"l3_a" : @"groupPrivateHeader";
            NSString *imageName = @"l3_a";
