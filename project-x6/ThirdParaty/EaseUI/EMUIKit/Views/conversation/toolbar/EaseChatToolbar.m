...
- (void)_setupSubviews
{
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"l2_f"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"l2_e"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"l2_d"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"l2_d"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"l2_e"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"l2_c"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"l2_d"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"l2_e"] forState:UIControlStateSelected];
