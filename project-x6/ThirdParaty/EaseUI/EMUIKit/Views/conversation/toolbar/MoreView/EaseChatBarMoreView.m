...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    [_photoButton setFrame:CGRectMake(22, 15, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    [_photoButton setImage:[UIImage imageNamed:@"l2_h"] forState:UIControlStateNormal];
//    [_photoButton setImage:[UIImage imageNamed:@"chatBar_colorMore_photoSelected"] forState:UIControlStateHighlighted];
    ...
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(22, 15 + CHAT_BUTTON_SIZE + 5, CHAT_BUTTON_SIZE, 20)];
    label1.textColor = ExtraTitleColor;
...
//    [_scrollview addSubview:_locationButton];
    ...
    [_takePicButton setFrame:CGRectMake(67 + CHAT_BUTTON_SIZE, 15, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    [_takePicButton setImage:[UIImage imageNamed:@"l2_g"] forState:UIControlStateNormal];
//    [_takePicButton setImage:[UIImage imageNamed:@"chatBar_colorMore_cameraSelected"] forState:UIControlStateHighlighted];
    ...
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(67 + CHAT_BUTTON_SIZE, 15 + CHAT_BUTTON_SIZE + 5, CHAT_BUTTON_SIZE, 20)];
    label2.textColor = ExtraTitleColor;
    label2.text = @"拍照";
